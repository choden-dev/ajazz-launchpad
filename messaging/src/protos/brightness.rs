...
//! Generated file from `commands/brightness.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_7_2;

// @@protoc_insertion_point(message:brightness.SetBrightness)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SetBrightness {
    // message fields
    // @@protoc_insertion_point(field:brightness.SetBrightness.brightness_value)
    pub brightness_value: u32,
    // special fields
    // @@protoc_insertion_point(special_field:brightness.SetBrightness.special_fields)
...
impl SetBrightness {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "brightness_value",
            |m: &SetBrightness| { &m.brightness_value },
            |m: &mut SetBrightness| { &mut m.brightness_value },
        ));
...
impl ::protobuf::Message for SetBrightness {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.brightness_value = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.brightness_value != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.brightness_value);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.brightness_value != 0 {
            os.write_uint32(1, self.brightness_value)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x19commands/brightness.proto\x12\nbrightness\":\n\rSetBrightness\x12)\
    \n\x10brightness_value\x18\x01\x20\x01(\rR\x0fbrightnessValueb\x06proto3\
";
